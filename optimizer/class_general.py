...
class Struct:
    ...
    def geom2list(self):
        ...
        for iatom in range(self.natom):
            tmp_str = "{:<15}{: 14.8f}{: 14.8f}{: 14.8f}".format(
                self.geom[iatom][0],
                self.geom[iatom][1][0],
                self.geom[iatom][1][1],
                self.geom[iatom][1][2],
    ...
    def read_grrm_opt_log(self):
        if os.path.isfile(self.path):
            ...
            opt_idx = [
                ...
                if "{}".format("OPTOPTOPTOPTOPTOPTOPTOPTOPTOPTOPTOPTOPTOPT") in line
            ]
            n_opt = len(opt_idx)
            if n_opt == 1:
                ...
                if tag:
                    ...
                    print(
                        self.path,
                        "ERROR: The JOB not finished, but massage_STOP not found.",
                    )
                ...
                struct_idx = [
                    i for i, line in enumerate(l) if "{}".format("Optimized") in line
                ]
                e_idx = [
                    i for i, line in enumerate(l) if "{}".format("ENERGY    =") in line
                ]
                g_idx = [
                    i
                    for i, line in enumerate(l)
                    if "{}".format("Free Energy   =") in line
                ]
